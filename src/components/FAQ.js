...
export const FAQ = () => {
  return (
    ...
    <div class="space-y-4 bg-white px-60 py-32 sm:py-32">
      <div class="flex items-start">
        <h1 class="text-4xl font-bold tracking-tight text-gray-900 lg:text-5xl">FAQ</h1>
      </div>
      ...
      <details class="group border-s-4 border-green-500 bg-gray-50 p-6 dark:bg-gray-900 [&_summary::-webkit-details-marker]:hidden">
        <summary class="flex cursor-pointer items-center justify-between gap-1.5">
          <h2 class="text-lg font-medium text-gray-900 dark:text-white">
            Lorem ipsum dolor sit amet consectetur adipisicing?
          </h2>
