...
export const Services = () => {
  return (
    <section className="bg-white text-black pb-12" id="ourservices">
      <div className="py-8 sm:py-12 lg:py-16 px-8 md:px-20 lg:px-48 justify-center">
        ...
        <div class="mt-8 grid grid-cols-1 gap-8 md:mt-16 md:grid-cols-2 md:gap-12 lg:grid-cols-3">
          <div class="flex items-start gap-4">
            <span class="shrink-0 rounded-lg bg-blue-700 p-4">
              <i className="h-5 w-5 fas fa-globe-americas text-gray-200 text-center"></i>
            </span>
            <div>
          ...
          <div class="flex items-start gap-4">
            <span class="shrink-0 rounded-lg bg-blue-700 p-4">
              <i className="h-5 w-5 fas fa-mobile-alt text-gray-200 text-center"></i>
            </span>
          ...
          <div class="flex items-start gap-4">
            <span class="shrink-0 rounded-lg bg-blue-700 p-4">
              <i className="h-5 w-5 fas fa-chart-line text-gray-200 text-center"></i>
            </span>
